...
<html>
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-md navbar-dark bg-dark">
            <div class="container">
                <a class="navbar-brand" href="HomeServlet">SHOES STORE</a>
                ...
                <div class="collapse navbar-collapse justify-content-end" id="navbarsExampleDefault">
                   ...
                   <form action="/Quanlykinhdoanhgiayonline/search" method="get" class="form-inline my-2 my-lg-0">
        ...
        <section class="jumbotron text-center">
            <div class="container">
                <h1 class="jumbotron-heading">BƯỚC VÀ TOẢ SÁNG</h1>
                <p class="lead text-muted mb-0">NƠI DÀNH CHO NHỮNG TÍN ĐỒ THỜI TRANG</p>
                <div id="banner">
			<img class="banner" src="image/slide/3.jpg">
		</div>
            </div>
        </section>
        <!--end of menu-->
    ...
    <li class="list-group-item text-white">
        <a href="category?TypeID=${o.typeID}">${o.typeName}</a>
    </li>
</c:forEach>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-lg-3 col-xl-3">
                        ...
                        <ul class="list-unstyled">
                            ...
                            <li><i class="fa fa-envelope mr-2"></i> email@gmail.com</li>
